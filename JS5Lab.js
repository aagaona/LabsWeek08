 ...
 * ↓ YOUR CODE HERE ↓ */
console.log (
  `On July 20th ${person.year}, ${person.firstname} ${person.lastname} wass the first person to set foot on the Earth's moon`
)
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting(`Alex`, `San Diego`)
myGreeting.hello()
...
let yourBook = new Book (`The Road`, `Cormac McCarthy`);
...
// Look at the provided code below. Notice s" and "super" key words. Also, how Student has a redefined details method that is more appropriate than the details method it would have inhow Student and Teacher inherit from the Person class through the use of the "extendherited from the Person super class...
